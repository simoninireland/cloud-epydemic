#!/bin/sh
#
# Start-up script for cluster frontend notebook
#
...
# We expect tweo environment variables to be defined by the container:
#
# - EPYDEMIC_HOME -- the home directory
# - EPYDEMIC_DATA -- the notebook data directory
#
# The data directory will typically be a mount point, to allow notebooks
# and data to persist.
#
# We also accept one optional run-time variable:
#
